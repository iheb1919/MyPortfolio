...
<AboutHeader 
          ...
          />
            ...
            <div className='w-full  rounded-xl overflow-hidden mx-auto' >
                <iframe width="100%" height="350" frameBorder="0" scrolling="no"  src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=tunis%20+(Car%20Rental)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/collections/drones/">drones ireland</a></iframe>
                </div>
...
export const ContactMethods = ()=>{
    ...
    return(
        <div className='  flex flex-col gap-5' >
            <h2 className='text-2xl   font-semibold xl text-[#6A727D] dark:text-[#BBBFC6] '> Get in Touch </h2>
<p className='text-[#6A727D] dark:text-[#BBBFC6]'>Travel duru nisl quam nestibulum ac quam nec odio elementum sceisue the aucan ligula. Orci varius natoque penatibus et magnis dis parturient monte nascete ridiculus mus nellentesque habitant morbine.</p>
            {
    ...
    return(
        <div className="flex w-fit  justify-center items-center text-[16px] gap-2 text">
             <div className=" flex justify-center items-center
               ...
               <Icon className=" w-full h-full text-[#6A727D] dark:text-[#BBBFC6]"/>
             </div>
...
<h2 className='text-2xl text-center p-5 bg-darkBlueGray font-semibold xl text-[#BBBFC6] '> Get in Touch </h2>
...
import { MailCloseFill, LocationEmpty, PhoneCallSpeaker, Clock28Regular } from '../assets/iconsSVG/svgIcons'

type AboutHeaderProps = {
    position?:string, background?:string,title:ReactElement
  }
  export const AboutHeader:React.FC<AboutHeaderProps> = ({background="url(/slider/15.jpg)",title,position}) => {
    return (
      <div style={
